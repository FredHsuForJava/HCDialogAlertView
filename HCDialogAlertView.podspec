...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xuwenfeng/HCDialogAlertView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xuwenfeng' => 'xuwf@bsoft.com.cn' }
  s.source           = { :git => 'https://github.com/xuwenfeng/HCDialogAlertView.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'HCDialogAlertView/Classes/**/*'
